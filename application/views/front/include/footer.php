				...
				<div class="col-lg-3 col-md-6 col-sm-12">
					<div class="footer-widget mb-40 footer-widget__about">
						<a href="index-2.html" aria-label="logo image">
							<img src="<?=base_url()?>assets/images/logo.png" class="footer-widget__logo" width="101" alt="">
						</a>
						<p>Lorem ipsum dolor sit amet consect etur adi pisicing elit sed.</p>
						<ul class="list-unstyled footer-widget__contact">
							<li>
								<a href="#">
									<i class="azino-icon-telephone"></i>666 888 0000</a></li>
							<li>
								<a href="#">
									<i class="azino-icon-email"></i>needhelp@dss.com</a></li>
							<li>
								<a href="#">
									<i class="azino-icon-pin"></i>88 Broklyn Golden Street, USA</a></li>
						</ul>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-12">
					<div class="footer-widget footer-widget__link mb-40">
						...
						<ul class="list-unstyled footer-widget__link-list">
							<li>
								<a href="causes.html">Our Causes</a></li>
							<li>
								<a href="about.html">About us</a></li>
							<li>
								<a href="news.html">New Campaign</a></li>
							<li>
								<a href="events.html">Upcoming Events</a></li>
							<li>
								<a href="about.html">Site Map</a></li>
							<li>
								<a href="contact.html">Help</a></li>
							<li>
								<a href="causes.html">Donate</a></li>
							<li>
								<a href="contact.html">Contact us</a></li>
							<li>
								<a href="contact.html">Terms</a></li>
						</ul>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-12">
					<div class="footer-widget mb-40 footer-widget__blog">
						<h3 class="footer-widget__title">Recent Activities</h3>
						<ul class="list-unstyled footer-widget__blog">
							<li>
								<img src="<?=base_url()?>assets/images/resources/footer-img-1-1.jpg" alt="">
								<p>22 May, 2020</p>
								<h3>
									<a href="news-details.html">You can help the poor in need</a></h3>
							</li>
							<li>
								<img src="<?=base_url()?>assets/images/resources/footer-img-1-2.jpg" alt="">
								<p>22 May, 2020</p>
								<h3>
									<a href="news-details.html">Rise fund for Healthy Food</a></h3>
							</li>
						</ul>
					</div>
				</div>
...
<div class="mobile-nav__wrapper">
	...
	<div class="mobile-nav__content">
		...
		<div class="logo-box">
			<a href="index-2.html" aria-label="logo image"><img src="<?=base_url()?>assets/images/logo.png" width="200" alt="" /></a>
		</div>
		<div class="mobile-nav__container"></div>
		<ul class="mobile-nav__contact list-unstyled">
			<li>
				<i class="azino-icon-email"></i>
				<a href="mailto:needhelp@dss.com">needhelp@dss.com</a>
			</li>
			<li>
